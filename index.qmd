# Welcome to The QPL Book {.unnumbered}
...
- **Open source** - Available at [github.com/dcoldeira/quantum-process-language](https://github.com/dcoldeira/quantum-process-language)
- **Tested** - Every example is verified to work with the latest QPL release
...
- **Issues**: [github.com/dcoldeira/qpl-book/issues](https://github.com/dcoldeira/qpl-book/issues)
- **Pull requests**: [github.com/dcoldeira/qpl-book](https://github.com/dcoldeira/qpl-book)
...
**Let's begin!** Start with [Chapter 1: Quantum Mechanics Basics](chapters/01-quantum-basics.qmd) or jump straight to hands-on tutorials in [Chapter 7: Your First Bell State](chapters/07-first-bell-state.qmd).
