...
## From Patterns to QRL

In the Quantum Relational Language, these patterns are **automatically generated** from high-level relational specifications.

### QRL Abstraction Levels
...
**Level 2: Graph Extraction** (QRL infers)
```
...
**Level 3: Measurement Pattern** (QRL compiles)
```
...
**Level 4: Photonic Backend** (QRL targets)
```
...
This **layered compilation** is the essence of QRL's design.
...
**Part II complete!** You now understand the MBQC foundations that power QRL.
...
**Next steps:**
- Revisit **[Part III: QRL Programming](../index.qmd#part-iii-qrl-programming)** with your new theoretical understanding
- Explore **Part IV: Advanced Topics** (Chapters 12-15) when ready

**You're now equipped to understand QRL's relations-first, MBQC-native approach to quantum programming!**
