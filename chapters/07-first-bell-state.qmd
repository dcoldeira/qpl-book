...
Welcome to your first hands-on QRL tutorial! In this chapter, you'll create your first quantum program: a Bell state - one of the most fundamental entangled quantum states.
...
First, make sure QRL is installed:
...
program = QRLProgram("My First Bell State")
```

## Creating Quantum Systems

In QRL, you don't create individual "qubits" - you create **quantum systems** that can then be entangled into **relations**:
...
Here's where QRL's philosophy shines. Instead of applying gates like `CNOT`, you directly express the **relationship** you want:
...
def main():
    # Create program
    program = QRLProgram("Complete Bell State Example")
...
✅ Created your first quantum program in QRL
...
**Next:** [Chapter 8: Understanding GHZ States](08-ghz-states.qmd) - Scale to 3+ qubits
