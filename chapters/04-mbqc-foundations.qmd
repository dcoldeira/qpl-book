...
This is not just a theoretical curiosity—it's the foundation of QRL's design philosophy and the native model for photonic quantum computers.
...
4. **QRL foundation:** Relations-first programming maps naturally to MBQC
...
✅ QRL is built on MBQC principles (relations-first)
