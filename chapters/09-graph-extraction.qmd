...
**Graph extraction** is the process of converting a QPL `QuantumRelation` into a graph representation where:
...
✅ **Graph extraction** - Converting QPL relations to graph states
...
- Compile complete QPL programs to MBQC
