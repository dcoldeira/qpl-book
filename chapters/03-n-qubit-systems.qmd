...
## Creating n-Qubit States in QRL

In the Quantum Relational Language, you can create GHZ and W states directly:

```python
from qrl import QRLProgram

program = QRLProgram("n-Qubit Entanglement")
...
**Part I Complete!** You now have the quantum foundations needed to understand MBQC and QRL.

## Exercises

### Exercise 3.1: GHZ State Verification {#exercise-3.1-ghz-state-verification}
...
[Solution →](../appendix/solutions.qmd#solution-3-1)

### Exercise 3.2: W State Properties {#exercise-3.2-w-state-properties}
...
[Solution →](../appendix/solutions.qmd#solution-3-2)

### Exercise 3.3: Entanglement Entropy Calculation {#exercise-3.3-entanglement-entropy-calculation}
...
[Solution →](../appendix/solutions.qmd#solution-3-3)

### Exercise 3.4: LOCC Impossibility {#exercise-3.4-locc-impossibility}
...
[Solution →](../appendix/solutions.qmd#solution-3-4)

### Exercise 3.5: Multipartite Correlation {#exercise-3.5-multipartite-correlation}
...
[Solution →](../appendix/solutions.qmd#solution-3-5)

### Exercise 3.6: Fragility vs Robustness {#exercise-3.6-fragility-vs-robustness}
...
[Solution →](../appendix/solutions.qmd#solution-3-6)

### Exercise 3.7: n-Qubit Generalization {#exercise-3.7-n-qubit-generalization}
